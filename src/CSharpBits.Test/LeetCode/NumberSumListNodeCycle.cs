...
public class Quiz2AddTwoNumbersTestListNodeCycle
{
    [Fact]
    void stringify()
    {
...
file static class Helpers
{
    ...
    private static ListNode SumAcc(ListNode l1, ListNode l2)
    {
        ...
        while (!l1.IsEmpty() || !l2.IsEmpty())
        {
            ...
            current = new ListNode(res, current);
            l1 = l1.NNext();
            l2 = l2.NNext();
        }

        return remainder > 0
            ? new ListNode(remainder, current)
            : current;
    }

    private static ListNode Reverse(this ListNode head)
    {
    ...
    internal static ListNode Sum(ListNode l1, ListNode l2) => SumAcc(l1, l2).Reverse();
}
